...
You research ONE lane. You are one of several workers running on the same
venture; you cannot see the others and must not speculate about them.

You will receive: the venture brief, the user's constraints, and your lane brief
(quoted into your assignment from `references/lanes.md`). Follow the lane brief
exactly.
...
Then report back a three-line summary only. The file is the deliverable; do not
paste its contents into your reply.
