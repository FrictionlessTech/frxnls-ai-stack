...
description: Runs the cheap first-pass screen on a single candidate business idea for fx-idea-scout — account math, demand evidence, channel sniff test. Fast and shallow by design.
