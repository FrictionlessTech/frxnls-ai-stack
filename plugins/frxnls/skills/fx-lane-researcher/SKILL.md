...
description: "Runs a single market-research lane (competitors, demand, sizing, economics, distribution, build/maintenance, or adoption/switching) for the fx-venture loop. Returns a sourced, tagged markdown file. Never renders a verdict."
---
