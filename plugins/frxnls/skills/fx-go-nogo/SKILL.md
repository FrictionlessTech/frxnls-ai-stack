...
Read `references/scorecard.md` for the rubric. Ten dimensions, weighted by what
...
Ask via a direct question to the user what happens next. Always ask — never chain
automatically.
