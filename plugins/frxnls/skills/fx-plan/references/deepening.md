...
~6 total max) through Codex subagent delegation, in parallel. Map by section:
...
discuss via a direct question to the user. On "discuss", talk it through, then re-ask
